...
\[Eta]=TrigExpand[{x1,y1}+l*{Cos[\[Theta]],Sin[\[Theta]]}+d*{Cos[\[Theta]-\[Alpha]],Sin[\[Theta]-\[Alpha]]}-{x2,y2}];
sold={d->-CoefficientList[Collect[\[Eta][[1]],d],d][[1]]/Coefficient[Collect[\[Eta][[1]],d],d]};
sol\[Theta]=solveLinTrig1[Collect[TrigExpand[Numerator[Together[\[Eta][[2]]/.sold]]],{Cos[\[Theta]],Sin[\[Theta]]}],\[Theta]];
sol=((#)\[Union](sold/.(#)))&/@sol\[Theta];
